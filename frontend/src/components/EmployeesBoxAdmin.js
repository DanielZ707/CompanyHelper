                                ...
                                users.map(({idUser, name, surname, email,  telephone, job, team,role}) => {
                                    return (<div className="usersWithButtons">
                                            ...
                                            <div className="popupAdmin">
                                                                    ...
                                                                    <form>
                                                                        ...
                                                                        <div className="login-email">
                                                                            <div className="setTeam-admin-field">
                                                                                <button type="button"
                                                                                        onClick={() => save(email, 'Admin')}>Admin
                                                                                </button>
                                                                                <button type="button"
                                                                                        onClick={() => save(email, 'Manager')}>Manager
                                                                                </button>
                                                                            </div>
                                                                            <div className="setTeam-admin-field">
                                                                                <button type="button"
                                                ...
                                                <Popup trigger={<button type="submit">Delete Employee</button>} modal
                                                       nested>
                                                    {close => (
                                                        <div className="modal">
...
export default EmployeesBoxAdmin;